...
const translations = {
  de: {
    ...
    description: "Eine mehrsprachige Hochzeitswebsite für Julia und Daniel.",
    "nav.weekend": "Wochenende",
    "nav.story": "Geschichte",
    "nav.travel": "Anreise",
    "nav.calendar": "Kalender",
    "nav.hotels": "Hotels",
    "hero.status": "<span>We are getting</span><span>married</span>",
    ...
    "events.map": '<a href="https://maps.app.goo.gl/RWy8xYNb6xHkX5Hu6">Karte zur Hochzeitslocation öffnen</a>',
    ...
    "events.dinner": "Abendessen, Reden und Tanzen bis spät",
    ...
    "story.title": "Ein paar Worte vor dem großen Tag.",
    "story.body": "Hier kann später Julias und Daniels Geschichte stehen: wie sie sich kennengelernt haben, was dieses Wochenende bedeutet und warum sie es mit euch feiern möchten.",
    "travel.label": "Anreise",
    "travel.title": "Kommt entspannt an und bleibt in der Nähe.",
    "travel.stayTitle": "Übernachten",
    "travel.stayBody": "Hotelvorschläge und Zimmerinfos für Julias und Daniels Gäste werden hier ergänzt.",
    "travel.moveTitle": "Hinkommen",
    "travel.moveBody": "Details zur Anreise und zu möglichen Shuttles werden hier hinzugefügt.",
    ...
    "hotels.title": "Hotels",
    "hotels.subtitle": "Empfehlungen für euren Aufenthalt",
    "hotels.hotel": "Hotel",
    "hotels.area": "Ort",
    "hotels.distance": "Distanz",
    "hotels.note": "Info",
    "hotels.link": "Link",
    "hotels.linkText": "Website",
    "hotels.areaOne": "Nahe der Location",
    "hotels.noteOne": "Zimmerblock angefragt",
    "hotels.areaTwo": "Innenstadt",
    "hotels.noteTwo": "Sehr schön für Paare",
    "hotels.areaThree": "Ruhige Lage",
    "hotels.noteThree": "Familienfreundlich",
    "hotels.areaFour": "Zentrum",
    "hotels.noteFour": "Gut für Gruppen",
    "hotels.small": "Bitte bucht frühzeitig. Genauere Links und Preise können hier später ergänzt werden.",
